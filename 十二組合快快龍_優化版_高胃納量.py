...
# 🔄 定期回測設定
# ============================================================================
BACKTEST_EVERY_N_GEN = 5     # 🔥 每 5 代執行一次詳細回測
...
OOS_TEST_EVERY_N_GEN = 5     # 🔥 每 5 代執行一次樣本外測試
...
class IndependentDataManager:
    ...
    def load_fresh_data(self):
        ...
        try:
            ...
            try:
            ...
            except (EOFError, MemoryError, pickle.UnpicklingError) as e:
                # 🔥 直接捕捉這些錯誤類型
                ...
                skip_keywords = ['memory', 'allocate', 'eof', 'input', 'pickle', 'corrupt', 'ran out']
